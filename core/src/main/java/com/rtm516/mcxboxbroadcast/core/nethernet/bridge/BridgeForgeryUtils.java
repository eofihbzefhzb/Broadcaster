...
final class BridgeForgeryUtils {
    private BridgeForgeryUtils() {
    }

    static String forgeToken(KeyPair pair, IdentityData data) {
    ...
    static String forgeSkinData(KeyPair pair, JSONObject skinData) {
        String publicKeyBase64 = Base64.getEncoder().encodeToString(pair.getPublic().getEncoded());
