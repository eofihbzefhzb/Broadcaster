...
public final class NetherNetBridgeServerSession extends BedrockServerSession {
    private BedrockSession sendSession;
    private BridgePlayerSession player;

    public NetherNetBridgeServerSession(BedrockPeer peer, int subClientId) {
